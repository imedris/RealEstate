...
<br>
  <div style="background: #28c8b6; width: 90%; height: 50px; margin: 10px; margin-left: 50px; border-radius: 15px;">
    <h2 style="font-family: CinzelDecorative-Regular; letter-spacing:5px ; font-weight: bold; text-align: center; padding: 5px;">Listing All Properties</h2>
</div>
